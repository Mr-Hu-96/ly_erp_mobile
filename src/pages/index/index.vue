  ...
  <view>
    <z-paging ref="paging" v-model="dataList" @query="queryList">
      ...
      <wd-card v-for="(item, index) in dataList" :key="index">
        ...
        <wd-steps :active="index" align-center>
          <wd-step title="拆包" class="!w-1/8" />
          <wd-step title="备料" class="!w-1/8" />
          <wd-step title="出格" class="!w-1/8" />
          <wd-step title="上色" class="!w-1/8" />
          <wd-step title="开料" class="!w-1/8" />
          <wd-step title="四楼主管签字" class="!w-1/4" />
          <wd-step title="油边" class="!w-1/8" />
          <wd-step title="五金" class="!w-1/8" />
          <wd-step title="车位" class="!w-1/8" />
          <wd-step title="台面" class="!w-1/8" />
        </wd-steps>
        <wd-grid>
